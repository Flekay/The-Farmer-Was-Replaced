...
sorting_func = {
	...
	"SouthNorth": "NorthSouthSort",
	"WestEast": "EastWestSort",
...
for dir in MOVES:
	...
	functions.append(f"def cacti_move_{i}(grid0, grid1, grid2, grid3, grid4, grid5, grid6, grid7, grid8, grid9):")
	if till:
	...
	if next_dir:
		...
		functions.append(f"\tcacti_move_{i+1}(grid0, grid1, grid2, grid3, grid4, grid5, grid6, grid7, grid8, grid9)")
	else:
