def north_Astar(coord_index, wall_dict, drone_coord, drone_x, drone_y, Astar_flow_field, queue, neighboors, index_converter):
	...
	if coord_index == drone_coord:
		...
		Astar_flow_field[coord_index] = (s_, South)
		return True
