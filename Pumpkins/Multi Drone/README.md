...
### `jarvan.py`
Advanced multi-drone coordination script operating on a 29x29 world. Uses hierarchical drone spawning with power-of-2 distribution patterns for efficient coverage.
