...
farm_cacti_twice_optimized544()
def farm_cacti_twice_optimized544():
	ws = get_world_size()
	ws_range = range(ws)
	l = []
	...
	moves = [
		...
		South,East,North,East,North,South,South,South,South,
		South,West,South,West,South,West,South,West,South,West,
		South,East,South,West,West,South,South,South,West,South
	]
	for dir in moves:
		move(dir)
		simple_swap()

	quick_print("preSort99",get_tick_count() - ticks)
