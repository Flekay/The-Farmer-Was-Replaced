...
farm_cacti_twice_optimized548()
def farm_cacti_twice_optimized548():
	ws = get_world_size()
	ws_range = range(ws)
	l = []
	...
	moves = [
	    ...
	    East,North,East,North,East,North,West,South,West,South,
	    West,South,West,South,West,South,West,South,West,North,
	    North,East,North,East,North,East,North,East,North,West,
	    South,West,South,West,South,West,North,North,East,North,
	    North,East,North,North,East,North,East,North,East,North,
	    East,North,East,South,West,South,West,South,West,South,
	    East,East,North,East,North,South,South,South,South,South,
	    West,South,West,South,West,South,West,South,West,South,West,South,West
	]
	for dir in moves:
		move(dir)
		simple_swap()

	quick_print("preSort93",get_tick_count() - ticks)
