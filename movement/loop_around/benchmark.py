...
quick_print("navi-map.py, Setup time:", boot_time, ", ops:", run_ops)
...
for direction in MOVES:
	...
	move(direction)
run_ops = get_tick_count() - run_ops - 40000
quick_print("navi-map-light.py, Setup time:", boot_time, ", ops:", run_ops)
...
for _ in range(SIZE):
	for direction in MOVES:
		...
		move(direction)
run_ops = get_tick_count() - run_ops - 40000
quick_print("navi-map-inline.py, Setup time:", boot_time, ", ops:", run_ops)
